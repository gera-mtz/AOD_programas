				...
				<div id="openModal" class="modalDialog">
					...
					<div>
						...
						<form name="registro" action="php/registro.php" method="post" enctype="multipart/form-data">
							...
							<!--uso de scrpts para añadir los guiones automaticos de la clave.. llamo las librerias-->
							...
							jQuery(function($)
							{
								$("#key").mask("a99a-9999-99a9-a990",{placeholder:" "});
							});
							</script>
							<br />
							<input type="label" placeholder="Foto*" />
